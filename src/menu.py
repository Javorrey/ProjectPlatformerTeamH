...
class MainMenu(arcade.View):
    ...
    def on_show_view(self):
        ...
        self.boton_jugar.center_y = 270

        self.boton_nivel.center_x = centro_x
        self.boton_nivel.center_y = 200

        self.boton_ajustes.center_x = centro_x
        self.boton_ajustes.center_y = 130
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if len(botones_pulsados) > 0:
            boton_clicado = botones_pulsados[0]
                ...
                #Nueva vista
            #elif boton_clicado == self.boton_nivel:
                #Nueva vista
            #elif boton_clicado == self.boton_ajustes:
                #Nueva vista
            if boton_clicado == self.boton_salir:
                arcade.exit()
...
if __name__ == '__main__':
    ventana = arcade.Window(800, 600, "Artemis 67 - Menú Principal")
    vista_menu = MainMenu()
